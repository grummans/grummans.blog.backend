...
/**
 * Controller for managing post attachments (files displayed separately from content)
 * These are different from inline content files - they appear in a separate "Attachments" section
 */
@RestController
...
public class PostAttachmentController {
     ...
     * Files will be stored in MinIO and metadata saved to post_attachment table
     *
    ...
    public ApiResponse<PostAttachments> uploadAttachment(
